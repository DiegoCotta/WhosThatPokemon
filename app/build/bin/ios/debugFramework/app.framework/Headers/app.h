...
@class AppGenaration, AppKotlinEnum, AppGenarationCompanion, AppKotlinArray, AppPokemon, AppSprite, AppPokemonCompanion, AppPokemon$serializer, AppSpriteCompanion, AppSprite$serializer, AppPokemonApi, AppKotlinUnit, AppKotlinThrowable, UIImage, AppKotlinByteArray, AppKotlinByteIterator, AppKotlinx_serialization_runtime_nativeEnumDescriptor, AppKotlinx_serialization_runtime_nativeSerialKind, AppKotlinNothing, AppKotlinx_serialization_runtime_nativeUpdateMode, AppKotlinx_serialization_runtime_nativeSerialClassDescImpl;

@protocol AppKotlinComparable, AppKotlinx_serialization_runtime_nativeKSerializer, AppKotlinx_serialization_runtime_nativeGeneratedSerializer, AppKotlinx_serialization_runtime_nativeSerializationStrategy, AppKotlinx_serialization_runtime_nativeEncoder, AppKotlinx_serialization_runtime_nativeSerialDescriptor, AppKotlinx_serialization_runtime_nativeDeserializationStrategy, AppKotlinx_serialization_runtime_nativeDecoder, AppKotlinIterator, AppKotlinx_serialization_runtime_nativeCompositeEncoder, AppKotlinx_serialization_runtime_nativeSerialContext, AppKotlinAnnotation, AppKotlinx_serialization_runtime_nativeCompositeDecoder, AppKotlinKClass, AppKotlinKDeclarationContainer, AppKotlinKAnnotatedElement, AppKotlinKClassifier;
...
__attribute__((swift_name("Genaration")))
@interface AppGenaration : AppKotlinEnum
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
@property (class, readonly) AppGenaration *g1;
@property (class, readonly) AppGenaration *g2;
@property (class, readonly) AppGenaration *g3;
@property (class, readonly) AppGenaration *g4;
@property (class, readonly) AppGenaration *g5;
@property (class, readonly) AppGenaration *g6;
@property (class, readonly) AppGenaration *g7;
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
- (int32_t)compareToOther:(AppGenaration *)other __attribute__((swift_name("compareTo(other:)")));
@property (readonly) NSString *geName;
@property (readonly) int32_t maxNumber;
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Genaration.Companion")))
@interface AppGenarationCompanion : KotlinBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (AppKotlinArray *)getArray __attribute__((swift_name("getArray()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Pokemon")))
@interface AppPokemon : KotlinBase
- (instancetype)initWithName:(NSString *)name sprites:(AppSprite *)sprites __attribute__((swift_name("init(name:sprites:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (AppSprite *)component2 __attribute__((swift_name("component2()")));
- (AppPokemon *)doCopyName:(NSString *)name sprites:(AppSprite *)sprites __attribute__((swift_name("doCopy(name:sprites:)")));
@property NSString *name;
@property AppSprite *sprites;
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Sprite")))
@interface AppSprite : KotlinBase
- (instancetype)initWithFrontDefault:(NSString * _Nullable)frontDefault backDefault:(NSString * _Nullable)backDefault __attribute__((swift_name("init(frontDefault:backDefault:)"))) __attribute__((objc_designated_initializer));
@property NSString * _Nullable frontDefault;
@property NSString * _Nullable backDefault;
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Sprite.Companion")))
@interface AppSpriteCompanion : KotlinBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AppKotlinx_serialization_runtime_nativeKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Sprite.$serializer")))
@interface AppSprite$serializer : KotlinBase <AppKotlinx_serialization_runtime_nativeGeneratedSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)$serializer __attribute__((swift_name("init()")));
- (AppSprite *)deserializeDecoder:(id<AppKotlinx_serialization_runtime_nativeDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (AppSprite *)patchDecoder:(id<AppKotlinx_serialization_runtime_nativeDecoder>)decoder old:(AppSprite *)old __attribute__((swift_name("patch(decoder:old:)")));
- (void)serializeEncoder:(id<AppKotlinx_serialization_runtime_nativeEncoder>)encoder obj:(AppSprite *)obj __attribute__((swift_name("serialize(encoder:obj:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PokemonApi")))
@interface AppPokemonApi : KotlinBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)getPokemonPokemonId:(int32_t)pokemonId success:(AppKotlinUnit *(^)(AppPokemon *))success failure:(AppKotlinUnit *(^)(AppKotlinThrowable * _Nullable))failure __attribute__((swift_name("getPokemon(pokemonId:success:failure:)")));
- (void)getPokemonSpriteSprite:(AppSprite *)sprite success:(AppKotlinUnit *(^)(UIImage * _Nullable))success failure:(AppKotlinUnit *(^)(AppKotlinThrowable * _Nullable))failure __attribute__((swift_name("getPokemonSprite(sprite:success:failure:)")));
@end;
